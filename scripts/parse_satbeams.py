...
ALLOWED_QUALITIES = {"SD", "HD", "4K", "3D", "UNKNOWN"}
...
def normalize_quality(value, channel_type):
    if channel_type == "RADIO":
        return "RADIO"
    text = clean(value).upper().replace("ULTRA HD", "4K")
    aliases = {"UHD": "4K", "2160P": "4K", "4K UHD": "4K", "UHD/4K": "4K", "4K/UHD": "4K", "FULL HD": "HD", "1080P": "HD", "720P": "HD"}
...
for sat in CONFIG:
    ...
    output = {
        ...
        "counts": {
            ...
            "uhd_4k": quality_counts.get("4K", 0),
